...
document.onreadystatechange = function () {
  if (document.readyState !== "complete") {
    ...
    document.querySelector(".preloader-container").style.visibility = "visible";
    document.querySelector(".preloader-container").style.top = "0px";
  } else {
    document.querySelector(".preloader-container").style.top = "-120%";
